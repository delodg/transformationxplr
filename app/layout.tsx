            ...
            <SignedOut>
              <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                  <h2 className="text-3xl font-bold text-gray-900 mb-4">Welcome to AI-Powered Transformation</h2>
                  <p className="text-gray-600 mb-8">Sign in to access your personalized finance transformation platform with intelligent insights and automation.</p>
